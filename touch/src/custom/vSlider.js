...
Ext.define('Ext.custom.vSlider',{
	...
	initialize:function(){
			...
			this.setStyle("transform:translate(-"+twidth+"px,0) translate(0,"+perytrans+"px) rotate(-90deg)");
			...
			this.helperInput.setStyle('transform', "rotate(90deg)");

...
Ext.define('Ext.ux.field.SliderFieldExtended', {
  ...
  setHelperValue: function(value) {
    ...
    this.helperInput.dom.value = Math.round(value*10)/10;
  },
  ...
  //Modif pour récupérer la valeur du Helper qui est arrondie à la décimale
  getHelperValue: function() {
    return this.helperInput.dom.value;
  },

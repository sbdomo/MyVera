...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Ext.ux.field.SliderFieldInput": [
    "Ext.form.SliderInput"
  ],
  ...
  "myvera.controller.Application": [],
  "myvera.controller.contconfig": [],
  "myvera.controller.contdevices": [],
  "myvera.model.Configdevices": [],
  "myvera.model.Configscenes": [],
  "myvera.model.CurrentUser": [],
  "myvera.model.Floors": [],
  "myvera.model.TabViews": [],
  "myvera.model.Veradevices": [],
  "myvera.model.modelRooms": [],
  "myvera.profile.Phone": [],
  "myvera.profile.Tablet": [],
  "myvera.store.ConfigDevicesStore": [],
  "myvera.store.ConfigScenesStore": [],
  "myvera.store.FloorsStore": [],
  "myvera.store.TabViewsStore": [],
  "myvera.store.devicesStore": [],
  "myvera.store.storeRooms": [],
  "myvera.util.Templates": [],
  "myvera.util.locale": [
    "locale"
  ],
  "myvera.view.PanelConfigClones": [],
  "myvera.view.PanelConfigFloor": [],
  "myvera.view.PanelConfigFloors": [],
  "myvera.view.PanelConfigFloorsNavigation": [],
  "myvera.view.PanelConfigGenerale": [],
  "myvera.view.PanelConfigItem": [],
  "myvera.view.PanelConfigItems": [],
  "myvera.view.PanelConfigItemsMenu": [],
  "myvera.view.PanelConfigMove": [],
  "myvera.view.PanelConfigNavigation": [],
  "myvera.view.PanelConfigRoom": [],
  "myvera.view.PanelConfigRooms": [],
  "myvera.view.PanelConfigRoomsNavigation": [],
  "myvera.view.PanelConfigScene": [],
  "myvera.view.PanelConfigScenes": [],
  "myvera.view.PanelConfigTab": [],
  "myvera.view.PanelConfigTabs": [],
  "myvera.view.PanelConfigViewsMenu": [],
  "myvera.view.PanelConfigWebview": [],
  "myvera.view.PanelConfigWebviews": [],
  "myvera.view.PanelImage": [],
  "myvera.view.carouselplan": [],
  "myvera.view.dataitem": [],
  "myvera.view.datamove": [],
  "myvera.view.dataplan": [],
  "myvera.view.paneloverlay": [],
  "myvera.view.phone.Main": [],
  "myvera.view.phone.PanelConfigphone": [],
  "myvera.view.phone.datalistoffphone": [],
  "myvera.view.phone.datalistonphone": [],
  "myvera.view.phone.datalistphone": [],
  "myvera.view.phone.listclockphone": [],
  "myvera.view.phone.panelinfophone": [],
  "myvera.view.tablet.Main": [],
  "myvera.view.tablet.PanelConfig": [],
  "myvera.view.tablet.datalist": [],
  "myvera.view.tablet.datalistoff": [],
  "myvera.view.tablet.dataliston": [],
  "myvera.view.tablet.listclock": [],
  "myvera.view.tablet.panelinfo": []
});
Ext.ClassManager.addNameAliasMappings({
  ...
  "myvera.util.locale": [],
  "myvera.view.PanelConfigClones": [
    "widget.PanelConfigClones"
  ],
  "myvera.view.PanelConfigFloor": [
    "widget.PanelConfigFloor"
  ],
  "myvera.view.PanelConfigFloors": [
    "widget.PanelConfigFloors"
  ],
  "myvera.view.PanelConfigFloorsNavigation": [
    "widget.PanelConfigFloorsNavigation"
  ],
  "myvera.view.PanelConfigGenerale": [
    "widget.PanelConfigGenerale"
  ],
  "myvera.view.PanelConfigItem": [
    "widget.PanelConfigItem"
  ],
  "myvera.view.PanelConfigItems": [
    "widget.PanelConfigItems"
  ],
  "myvera.view.PanelConfigItemsMenu": [
    "widget.PanelConfigItemsMenu"
  ],
  "myvera.view.PanelConfigMove": [
    "widget.PanelConfigMove"
  ],
  "myvera.view.PanelConfigNavigation": [
    "widget.PanelConfigNavigation"
  ],
  "myvera.view.PanelConfigRoom": [
    "widget.PanelConfigRoom"
  ],
  "myvera.view.PanelConfigRooms": [
    "widget.PanelConfigRooms"
  ],
  "myvera.view.PanelConfigRoomsNavigation": [
    "widget.PanelConfigRoomsNavigation"
  ],
  "myvera.view.PanelConfigScene": [
    "widget.PanelConfigScene"
  ],
  "myvera.view.PanelConfigScenes": [
    "widget.PanelConfigScenes"
  ],
  "myvera.view.PanelConfigTab": [
    "widget.PanelConfigTab"
  ],
  "myvera.view.PanelConfigTabs": [
    "widget.PanelConfigTabs"
  ],
  "myvera.view.PanelConfigViewsMenu": [
    "widget.PanelConfigViewsMenu"
  ],
  "myvera.view.PanelConfigWebview": [
    "widget.PanelConfigWebview"
  ],
  "myvera.view.PanelConfigWebviews": [
    "widget.PanelConfigWebviews"
  ],
  "myvera.view.PanelImage": [
    "widget.PanelImage"
  ],
  ...
  "myvera.view.phone.PanelConfigphone": [
    "widget.PanelConfigphone"
  ],
  "myvera.view.phone.datalistoffphone": [
    "widget.datalistoffphone"
  ],
  "myvera.view.phone.datalistonphone": [
    "widget.datalistonphone"
  ],
  "myvera.view.phone.datalistphone": [
    "widget.datalistphone"
  ],
  "myvera.view.phone.listclockphone": [
    "widget.listclockphone"
  ],
  "myvera.view.phone.panelinfophone": [
    "widget.panelinfophone"
  ],
  "myvera.view.tablet.Main": [
    "widget.main"
  ],
